                            ...
                            <div class="dataTable_wrapper">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                    	...
                                    	$SQL = "SELECT * FROM tblairlines ORDER BY air_line_id DESC";			
									...
									?>
                                        ...
                                        <tr class="odd gradeX" id="DelID_<?php echo $row['air_line_id'];?>">
                                            ...
                                            <td class="center"><?php echo $row['air_line_name'];?></td>

                                            <td class="center"><?php echo $row['air_line_code'];?></td>

                                            <td class="center"><img src="images/air_lines/<?php echo $row['air_line_image'];?>" height="25" width="70" alt="Air Line"></td>
