        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <h1 class="page-header">View Top Banner</h1>
                            ...
                            <div class="dataTable_wrapper">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                    	...
                                    	$SQL = "SELECT * FROM tbltopbanner ORDER BY banner_id DESC";			
									...
									?>
                                        ...
                                        <tr class="odd gradeX" id="DelID_<?php echo $row['banner_id'];?>">
                                            ...
                                            <td class="center"><img src="images/top_banners/<?php echo $row['banner_image'];?>" height="25" width="70" alt="Logo"></td>
                                            ...
                                            <td class="center"><a href="top_banner?id=<?php echo $row['banner_id'];?>"><img height="16" width="16" src="../images/edit.png" alt="Edit"></a>&nbsp;&nbsp;&nbsp;<a id="<?php echo $row['banner_id'];?>" class='clsDelete cursor'><img data-target="#myModal" data-toggle="modal" src="../images/delete.png" height="16" width="16" alt="Delete"></a></td>
