...
<body>
                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                    <?php
                                    	$SQL = "SELECT * FROM tblemployee ORDER BY employee_id DESC";			
										 $result = MySQLQuery($SQL);
										 while($row = mysql_fetch_array($result)) { // ,MYSQL_ASSOC
									?>
                                        <tr class="odd gradeX" id="DelID_<?php echo $row['employee_id'];?>">
                                            <td class="center"><?php echo $row['employee_name'];?></td>
                                            <td class="center"><?php echo $row['employee_email'];?></td>
                                            
                                            <td class="center"><a href="employee?id=<?php echo $row['employee_id'];?>"><img height="16" width="16" src="../images/edit.png" alt="Edit"></a>&nbsp;&nbsp;&nbsp;<a class='cursor clsDelete' id="<?php echo $row['employee_id'];?>"><img data-target="#myModal_emp" data-toggle="modal" src="../images/delete.png" height="16" width="16" alt="Delete"></a></td>
                                        </tr>
									<?php } ?>	
    ...
    <!-- /#wrapper -->
	<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModal_emp" class="modal fade" style="display: none;">
