<?php
include_once('../unique/conn.php');
$SQL = "SELECT * FROM tbluser WHERE user_id = ".(int)$_SESSION["client_id"]." ORDER BY id DESC";            
                    ...
                    <div class="divrow">
                        <div class="fromrow">
                            ...
                            <div class="left w50pc w100pc640">
                                <input name="ctl00$cphContent$txtUsername" type="hidden" value="ibrahimishaq86@gmail.com" maxlength="255" id="cphContent_txtUsername" class="txtbox w200px" />
                            </div>
                        </div>
                    </div>
                    <div class="divrow">
                        <div class="fromrow">
                            <div class="left textright textleft640 w35pc w100pc640">&nbsp;</div>
                            <div class="left w50pc w100pc640">
                                <input name="ctl00$cphContent$txtPassword" type="hidden" value="Ibrahim@786" maxlength="50" id="cphContent_txtPassword" class="txtbox w200px" />
                            </div>
                        </div>
                    </div>
                    <div class="clearboth"></div>
