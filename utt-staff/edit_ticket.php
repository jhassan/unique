...
<body>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <input type="hidden" name="user_id" id="user_id" value="48" />
										...
										TextField("Amount", "amount", $row['amount'], "20","6","form-control required number_only");
                                        ...
                                        <button type="button" id="submit_button" class="btn btn-default m-t-10">Edit</button>
    ...
    $(document).ready(function (){
        $("#submit_button").click(function (){
            $('#myForm').submit();
            //window.location.href = 'http://localhost/eticket/utt-staff/account_statement.php?admin_user_id=48';
            // window.open(
            //           'http://toursview.com/unique/account_statement.php?admin_user_id=<?php echo $row['user_id']; ?>',
