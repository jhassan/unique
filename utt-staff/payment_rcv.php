...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" id="title_account_statement"><?php if(!empty($user_id)) echo "Payments RCV: ". UserName($user_id); else echo "Payments RCV";  ?></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                            ...
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php
                                        ...
                                        $SQL = "";
                                        $SQL = "SELECT * FROM tblepayment WHERE user_id = ".(int)$user_id." 
