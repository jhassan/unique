<?php include_once('top.php');
		$Where = " text_id = '1'";
		$strRow = GetRecord("tblpersonaltext", $Where);
		$text_details = $strRow['text_details'];?>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <input type="hidden" name="action" id="action" value="AddPersonalInfo" />
						            <input type="hidden" name="ID" id="ID" value="<?php echo $ID; ?>" />
                                        <div class="form-group col-lg-12" style="margin-top:30px;">
										<?php
										echo "<textarea cols='' rows='7' name='text_details' class='form-control col-lg-6'>$text_details</textarea>";
										?>
                                        </div>
                                        <div class="clear"></div>
