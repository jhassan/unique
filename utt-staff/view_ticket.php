                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                ...
                                <table class="table table-responsive table-bordered table-hover">
                                    ...
                                    <?php
                                        ...
                                        {   
                                         ...
                                         {
                                             $SQL = "SELECT * FROM tblissuerefund WHERE (pnr = '".$search."' OR id = '".$search."') ORDER BY id DESC LIMIT {$startpoint} , {$per_page}";
                                         }      
                                         //echo $SQL;
                                ...
                                {   
                                 ...
                                 {
                                    $count_query = "tblissuerefund WHERE (pnr = '".$search."' OR id = '".$search."') ORDER BY id DESC";
                                 }
                                if(empty($search))
