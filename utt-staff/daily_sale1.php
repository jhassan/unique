                                ...
                                <table class="table table-responsive table-bordered table-hover">
									...
									?>
                                        <tr class="odd gradeX" id="DelID_<?php echo $row['id'];?>">
                                            ...
                                            <td class="left hide" id="Created_By_User_<?php echo $row['id'];?>"><?php echo UserName($row['user_id']);?></td>
                                            <td class="left"><?php echo GetEmployeeName($row['user_id']);?></td>
                                            <td class="left"><?php echo UserName($row['update_user_id']);?></td>
                                            <td class="left hide" style="padding-top: 0;padding-bottom: 0;">
                                            ...
                                            <td class="left hide" id="ModeType_<?php echo $row['id'];?>"><?php echo $arrIssue[$row['mode_type'] - 1];?></td>
                                            <td class="left">
