...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" id="title_account_statement"><?php if(!empty($user_id)) echo "Account Statement: ". UserName($user_id); else echo "Account Statement";  ?></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                            ...
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php
                                        ...
                                        $SQL = "SELECT * FROM tblissuerefund WHERE user_id = ".(int)$user_id." AND (ticket_status = 2 OR ticket_status = 6)  ORDER BY id ASC"; // AND `date` LIKE '%".$current_date."%'        
                                         $result = MySQLQuery($SQL);
                                         while($row = mysql_fetch_array($result)) { // ,MYSQL_ASSOC
                            ...
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php
                                        ...
                                        $SQL = "";
                                        $SQL = "SELECT * FROM tblissuerefund WHERE user_id = ".(int)$user_id." AND (ticket_status = 3 OR ticket_status = 4) ORDER BY id ASC";         
                                         $result = MySQLQuery($SQL);
                                         while($row = mysql_fetch_array($result)) { // ,MYSQL_ASSOC
                                            $ticket_status = $row['ticket_status'];
                                            $inprocess_selected = "";
                            ...
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php
                                        ...
                                        $SQL = "";
                                        $SQL = "SELECT * FROM tblepayment WHERE user_id = ".(int)$user_id." AND payment_status = 2 ORDER BY id ASC";            
                                         $result = MySQLQuery($SQL);
                                         while($row = mysql_fetch_array($result)) { // ,MYSQL_ASSOC
