<?php include_once('top.php');
...

	{
		...
		$strRow = GetRecord("tblnotification", $Where);
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <input type="hidden" name="action" id="action" value="AddPostNotification" />
						            ...
						            <input type="hidden" name="ID" id="ID" value="<?php echo $ID; ?>" />
                                        ...
                                        <input type="radio" value="1" checked="checked" id="optionsRadiosInline1" name="text_status">Enable
                                        </label>
                                        <label class="radio-inline">
                                      ...
                                      <input type="radio" <?php echo $EnDisColor1;?> value="1" id="optionsRadiosInline3" name="text_color">Black
                                        ...
                                        <div class="clear"></div>
                                        <div class="form-group m-r-5 m-t-10 col-lg-4 p-l-0">

                                            <label>Upload Image</label>

                                            <input type="file" name="fileToUpload" id="fileToUpload" <?php if(empty($ID)) { ?> class="required" <?php } ?>>
                                        ...
                                        <div class="form-group col-lg-4 m-t-10">
                                            ...
                                            <img src="../unique/images/notification_images/<?php echo $text_image;?>" height="50" width="100" alt="Image">
