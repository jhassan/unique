...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">View un Read Ticket</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <table class="table table-responsive table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                    <?php
                                    	$SQL = "SELECT * FROM tblissuerefund WHERE is_active = 0 ORDER BY id DESC";			
									...
									?>
                                        <tr class="odd gradeX" id="DelID_<?php echo $row['id'];?>">
                                            ...
                                            <td class="left hide"><a href="" id="<?php echo $row['id'];?>" data-toggle="modal" data-target=".bs-example-modal-lg4" class="add_new_comments">Add Comment</a></td>
                                            <td class="left">
                                            ...
                                            {
                                            ?>
                                            <!-- <td class="left"><input class="form-control get_commissions number_only" <?php echo $disabled_class; ?> type="text" style="width: 100px;" name="user_commisions" id="user_commisions_<?php echo $row['id'];?>" value="<?php echo $user_commisions; ?>"></td> -->
